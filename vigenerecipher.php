...
function Cipherv($input, $key, $encipher)
{
    $keyLen = strlen($key);
...
function Encipherv($input, $key)
{
    return Cipherv($input, $key, true);
}

function Decipherv($input, $key)
{
    return Cipherv($input, $key, false);
}
